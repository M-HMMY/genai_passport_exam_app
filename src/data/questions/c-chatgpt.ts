...
export const cChatgptQuestions: Question[] = [
  {
    ...
    choices: [
      ...
      'ChatGPT は文章を処理するモデルの名前、GPT はそれを提供する会社の名前',
  ...
  },
  {
    ...
    choices: [
      ...
      '次に来そうな言葉を選び続けて文章を作っており、事実を調べる仕組みではないため',
      '学習に使ったデータの多くが誤っており、正しい情報を持ち合わせていないため',
  ...
  },
  {
    ...
    choices: [
      'アライメントは手段、RLHF は目標であり、ファインチューニングは追加調整の広い方法である',
  ...
  },
  {
    ...
    choices: [
      ...
      'パラメータが多いモデルは、どのような用途でも高い精度を示すものと考えてよい',
  ...
  },
  {
    ...
    choices: [
      ...
      'Code Interpreter は自分用の ChatGPT を作る仕組み、GPTs はデータをプログラムで解析・処理する機能',
