...
export const kPromptQuestions: Question[] = [
  {
    ...
    choices: [
      '言葉の並び方を学び、それまでの言葉に続く言葉を確率で予測する仕組み',
  ...
  },
  {
    ...
    answer: 1,
    explanation:
      'イが正しい。文章の続きを予測する基本は同じで、広い分野の大量の文章を学ぶため、回答・要約・翻訳・文章作成などをこなせます。アは別の仕組みとした誤りです。ウは新旧が逆です。エは扱うデータの種類による区別で、どちらも言語を扱うモデルです。',
    level: 1,
  },
  {
    id: 'k-prompt-q04',
  ...
  },
  {
    ...
    choices: ['Instruction', 'Context', 'Input Data', 'Output Indicator'],
    answer: 3,
    explanation:
  ...
  },
  {
    ...
    choices: [
      'よいプロンプトには、4 要素が必ずすべて含まれていなければならない',
      'Few-Shot は Zero-Shot より常に優れた結果になるため、必ず例を付けるべきである',
      'プロンプトは長いほど手掛かりが増えるため、常に詳しく書くほうがよい',
      '4 要素は必要な手掛かりを考える枠組みで、単純な依頼なら一部だけでも通じる',
    ],
    answer: 3,
    explanation:
      'エが正しい。「この文を英訳してください」のように目的と材料が明らかなら、短いプロンプトで足ります。アは「必ず」と言い切った誤りです。イも「常に」と言い切った誤りで、例を作る手間がかかり、偏った例に引きずられることもあります。ウは長さを優先した誤りで、大切なのは必要な手掛かりがあることです。',
    level: 2,
  },
];
