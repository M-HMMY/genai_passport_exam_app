  ...
  return (
    <div className="page">
      ...
      <section className="section">
        ...
        <div className="table-wrap">
          <table>
            ...
            <tbody>
              <tr>
                <td>形式</td>
                <td>四肢択一式（一部複数選択を含む）の知識問題のみ。記述も実技もない</td>
              </tr>
              <tr>
                <td>問題数・時間</td>
                <td>60 問を 60 分。1 問あたりちょうど 60 秒</td>
              </tr>
              <tr>
                <td>実施</td>
                <td>オンライン（IBT）年 5 回（2・4・6・8・10 月）。各回とも受験期間は 1 か月ある</td>
              </tr>
              <tr>
                <td>受験条件</td>
                <td>なし。誰でも受けられる</td>
              ...
              <tr>
                <td>受験料</td>
                <td>一般 11,000 円 / 学生 5,500 円（いずれも税込）</td>
              </tr>
              <tr>
                <td>出題範囲</td>
                <td>公式シラバス（2026 年 2 月試験より適用）。第 1 章〜第 5 章</td>
              </tr>
              <tr>
                <td>合格基準</td>
                <td><strong>非公表</strong>。合格率は 2026 年 6 月試験で 79.90 %</td>
              </tr>
            </tbody>
          </table>
        </div>
        ...
        <p className="hint">
          ※ この表は 2026 年 9 月時点のものです。シラバスは 2026 年 2 月試験から改訂され、RAG・AI エージェント・AI 新法が加わりました。
          要項もシラバスも改訂されるので、申し込みの前に GUGA の公式サイトで最新の情報を確認してください。
        </p>
      </section>
    </div>
  );
